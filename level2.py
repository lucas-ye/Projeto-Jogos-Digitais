...
class Level2(state._State):
    def __init__(self):
        super().__init__()
        self.current_state = "level2"
    ...
    def startup(self, current_time, persist):
        ...
        self.overhead_info_display = info.OverheadInfo(self.game_info, "level2")
    ...
    def setup_background(self):
        ...
        proportions"""
        self.background = pg.image.load("./resources/graphics/level_2.png")
